...
<head>
    ...
    <meta property="og:title" content="Я иду на Бесплатный DEV-Intensive по Node.js backend & React frontend" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="http://skill-branch.ru/backend" />
    <meta property="og:image" content="http://skill-branch.ru/img/nodejs-image.jpg" />
    <meta property="og:description" content="Всего за 30 дней будут изучены современные технологии и подходы для разработки - гибких, масштабируемых, высоконагруженных Web-приложений" />
 ...
 <div id="loader-wrap" style="position: fixed;top: 0;bottom: 0;right: 0;left: 0;z-index: 9999;background-color: #000;"><div class="loader"></div>
    ...
    <div id="login" class="modal-window">
        ...
        <form action="#" method="POST" role="form" class="">
            <!-- for utm -->
            <input type="hidden" id="currentPage" value="Backend">
                    ...
                    <div class="block-wrap row">
                        ...
                        <div class="offer page">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 offer-inner">
                                <p class="underline-text">Бесплатный DEV-Intensive</p>
                                <p class="title">Node.js backend & React frontend</p>
                                <p class="ps">Разрабатываем на самых передовых WEB-­технологиях</p>
                                <p class="ps pps">Дата начала 01.11.2016</p>
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xs-offset-0 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 trend-inner">
                            <ul class="trend-list">
                                <li class="trend-list-item col-xs-12 col-sm-4 col-md-4 col-lg-4 active">
                                    <a href="#" class="nav-link" data-nav="Backend Beginner"></a>
                                ...
                                <li class="trend-list-item col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
                                    <a href="http://skill-branch.ru/backend-middle" class="nav-link" data-nav="Backend Middle"></a>
                                    <div class="trend-list-item-inner">
                                        <div class="ico-wrap">
                                            <i class="ico-2"></i>
                                        </div>
                    ...
                    <div class="course-content-inner row">
                        <ul class="course-content-list">
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <div class="desc">
                                    ...
                                    <div class="detail">
                                        ...
                                        <ul>
                                            <li>Описание структуры курса, организационные моменты. Ответы на вопросы.</li>
                                            <li>История JavaScript.</li>
                                            <li>Где применяется современный JavaScript.</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <p class="num">02</p>
                                <div class="desc">
                                    <p class="title">Hello JS World</p>
                                    ...
                                    <div class="detail">
                                        ...
                                        <ul>
                                            <li>Изучим основные архитектурные черты JavaScript.</li>
                                            <li>Обзорно пройдемся по новым конструкциям ES6, ES7.</li>
                                            <li>JavaScript на сервере - Node.js.</li>
                                            <li>Пакетный менеджер NPM.</li>
                                            <li>Познакомимся с инструментом Babel.</li>
                                            <li>Паттерны асинхронного программирования (Promises, bluebird).</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <p class="num">03</p>
                                <div class="desc">
                                    <p class="title">Node.js & Express.js</p>
                                    <p class="time">2 часа теории, 5 часов практики</p>
                                    <a href="#" class="detail-btn"></a>
                                    <div class="detail">
                                        <ul>
                                            <li>Познакомимся с фреймворком Express.JS</li>
                                            <li>Концепция средних слоев: express middlewares</li>
                                            <li>JSON RESTful API</li>
                                            <li>Познакомимся с СУБД MongoDB. Изучим инструменты работы с СУБД.</li>
                                            <li>Mongoose - ORM под MongoDB</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <p class="num">04</p>
                                <div class="desc">
                                    <p class="title">JSON RESTful API Server</p>
                                    <p class="time">2 часа теории, 4 часа практики</p>
                                    <a href="#" class="detail-btn"></a>
                                    <div class="detail">
                                        <ul>
                                            <li>JWT</li>
                                            <li>Архитектура написания удобного API.</li>
                                            <li>Express-async-router</li>
                                            <li>Документация API с помощью Swagger.</li>
                                            <li>Работа с API через Postman.</li>
                                            <li>Тестирование: Unit тесты и интеграционные тесты</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <div class="desc">
                                    ...
                                    <div class="detail">
                                        <ul>
                                            <li>Как работает React, что такое Virtual DOM</li>
                                            <li>Концепция Компонентов, Pure components</li>
                                            <li>Популярные пакеты под React</li>
                                            <li>Сборщик Webpack</li>
                                            <li>Модульный CSS, пакет CSS Modules</li>
                                            <li>Визуальное тестирование компонентов с помощью Storybook</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <p class="num">06</p>
                                <div class="desc">
                                    <p class="title">Isomorphic webapp</p>
                                    <p class="time">2 часа теории, 6 часов практики</p>
                                    <a href="#" class="detail-btn"></a>
                                    <div class="detail">
                                        <ul>
                                            <li>Server side rendering</li>
                                            <li>React-starter-kit</li>
                                            <li>Работа с вебсокетами. Socket.io</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <p class="num">07</p>
                                <div class="desc">
                                    <p class="title">Как создать изоморфное клиент серверное реалтайм приложение с нуля за 2 часа
                                    </p>
                                    <p class="time">2 часа теории, 16 часов практики</p>
                                    <a href="#" class="detail-btn"></a>
                                    <div class="detail">
                                        <ul>
                                            <li>Познакомимся с удобной наследуемой и переопределяемой ООП архитектурой сервера
                                            </li>
                                            <li>Создадим мультиплеерное приложение, которое будет в реалтайме общаться с сервером
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <li class="course-content-list-item col-xs-12 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <p class="num">08</p>
                                <div class="desc">
                                    <p class="title">Финальная встреча, закрытие курса, благодарности.</p>
                                    <p class="time">2 часа теории, 2 часа практики</p>
                                    <a href="#" class="detail-btn"></a>
                                    <div class="detail">
                                        <p>
                        ...
                        <div class="macbook-wrap">
                            ...
                            <div class="swiper-container macbook">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="img-wrap" style="background: url('img/backend/macbook/02.png') no-repeat transparent 50% 50%; background-size: cover"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="img-wrap" style="background: url('img/backend/macbook/03.png') no-repeat transparent 50% 50%; background-size: cover"></div>
                                    </div>
<!--                                     <div class="swiper-slide">
                                        <div class="img-wrap" style="background: url('img/backend/macbook/04.png') no-repeat transparent 50% 50%; background-size: cover"></div>
                                    </div> -->
<!--                                     <div class="swiper-slide">
                                        <div class="img-wrap" style="background: url('img/backend/imac/05.png') no-repeat transparent 50% 50%; background-size: cover"></div>
                                    </div> -->
                                    <!-- <div class="swiper-slide">
            ...
            <section id="block-8" class="how-do-it-wrap imac-wrap">
                <div class="wrap-container">
                    <div class="title-wrap row">
                        ...
                        <div class="col-xs-10 col-sm-9 col-md-9 col-lg-9 title-inner">
                            <p class="title">Вашe будущее портфолио</p>
                        </div>
                    </div>
                    <ul class="how-do-it-list row block-8-1">
                        ...
                        <li class="how-do-it-list-item col-xs-12 col-sm-4 col-md-4 col-lg-4" style="text-align: left">
                    ...
                    <div class="row desktop-only">
                        <div style="position: relative;">
                            <div class="cert-mini cert-mini_attach-rb">
                                <img class="cert-mini__img" src="../img/cert-card.jpg" />
                            </div>
                            <div class="mockup mockup_type_imac">
                                <div class="mockup__bg">
                                </div>
                                <!-- <div class="mockup_content"> -->
                                <div class="swiper-container imac mockup__content">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
...
<!--                                         <div class="swiper-slide">
                                            <div class="img-wrap" style="background: url('img/backend/imac/04.png') no-repeat transparent 50% 50%; background-size: cover"></div>
                                        </div> -->
<!--                                         <div class="swiper-slide">
                                            <div class="img-wrap" style="background: url('img/backend/imac/05.png') no-repeat transparent 50% 50%; background-size: cover"></div>
                                        </div> -->
                    ...
                    <ul class="how-do-it-list row block-8-2">
                        <li class="how-do-it-list-item col-xs-12 col-sm-2 col-md2 col-lg-2 desktop-only" style="text-align: left">
                        </li>
                        <li class="how-do-it-list-item col-xs-12 col-sm-4 col-md-4 col-lg-4" style="text-align: left">
                            <p class="title">Бесплатное обучение</p>
                            <p>Лучшие выпускники получат бюджетные места на продвинутом курсе Middle Node.JS</p>
                        </li>
                        <li class="how-do-it-list-item col-xs-12 col-sm-3 col-md-3 col-lg-3 desktop-only" style="text-align: left">
                            <img src="../img/arrow2.png" style="position:absolute; top: -25px;" />
                        </li>
                    </ul>
                </div>
            </section>
                            ...
                            <div class="resume-middle">
                                ...
                                <div class="money-info-wrap col-xs-12 col-sm-5 col-md-5 col-lg-5 col-xs-offset-0 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 pull-right">
                                    <div class="money-info">
                                        ...
                                        <p class="sum">от <span>70 000 <i class="fa fa-rub" aria-hidden="true"></i></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="wrap-container">
                    ...
                    <div class="friends-inner row">
                        <ul class="friends-list">
                            ...
                            <li class="friends-list-item">
                                <img src="img/backend/logos/6.png" alt="Node.js">
                            </li>
                            <li class="friends-list-item">
                    ...
                    <div class="entry-training-inner row">
                        <div class="left-part col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xs-offset-0 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                            <div class="without-discount">
                                ...
                                <p class="strike-text">18 900 <i class="fa fa-rub" aria-hidden="true"></i></p>
                            </div>
                        ...
                        <div class="right-part col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <p class="ps">дата начала 01.11.2016</p>
                            <form action="#" method="POST" role="form" class="form mailphp5">
                                <input type="hidden" id="name" class="name" value="form7">
                                <input type="hidden" id="form-title" class="form-title" value="Backend Junior">
                                <div class="row">
                            ...
                            <div class="result-inner row">
                                <div class="footer-bottom row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 share-wrap" style="text-align:center">
                                        <div class="ya-share2" data-services="facebook,vkontakte,twitter" data-image="http://skill-branch.ru/img/nodejs-image.jpg" data-url="http://skill-branch.ru/backend" data-description="Всего за 30 дней будут изучены современные технологии и подходы для разработки - гибких, масштабируемых, высоконагруженных Web-приложений" data-title="Я иду на Бесплатный DEV-Intensive по Node.js backend & React frontend"></div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
